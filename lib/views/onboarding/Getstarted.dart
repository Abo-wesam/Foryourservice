...
class Getstarted extends StatefulWidget{
  ...
  @override
  State<StatefulWidget> createState()=>GetstartedSatat();

}
class GetstartedSatat extends State<Getstarted> {
  final DashboardController cgetpage=Get.put(DashboardController());
